...
const About = () => {
  return (
      ...
      <div className="a-right">
        ...
        <div className="a-award-1">
          ...
          <div className="a-award-texts">
            <p className="a-award-title">Certificado Rolling Code School</p>
            <p className="a-award-desc">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Architecto doloribus dolores,{" "}
            </p>
          </div>
        </div>
        ...
        <a href="#id01">
          ...
          <div className="a-award-texts">
            <p className="a-award-title">Certificado Argentina Programa</p>
            <p className="a-award-desc">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Architecto doloribus dolores,{" "}
            </p>
    ...
    <div className="modal-container">
      <div className="modal-content">
        <a href="#about" className="closebtn"><i class="fa fa-long-arrow-left"></i> Back</a>
  ...
  <div id="id01" className="modal">
    <div className="modal-container">
      <div className="modal-content">
        <a href="/#" className="closebtn"><i className="fa fa-long-arrow-left"></i> Back</a>
